...
wget -O /usr/bin/ws "http://rajaserver.web.id/os/sshws/ws"
chmod +x /usr/bin/ws
wget -O /usr/bin/config.con "http://rajaserver.web.id/os/sshws/config.conf"
...
wget -O /usr/local/bin/ws-ovpn "http://rajaserver.web.id/os/sshws/ws"
