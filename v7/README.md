...
### INSTALL SCRIPT 
<pre><code>apt update -y && apt install -y wget curl && wget -q http://rajaserver.web.id/v7/setup.sh && chmod +x setup.sh && ./setup.sh
</code></pre>

### PERINTAH UPDATE 
<pre><code>wget -q http://rajaserver.web.id/v7/menu/update.sh && chmod +x update.sh && ./update.sh</code></pre>
