function sendWhatsAppRequest() {
    ...
    let message = `*REQUEST VPS DIGITAL OCEAN - ARISCTUNNEL V4*\n\n`;
    message += `*Detail Request:*\n`;
    message += `• *Server:* DIGITAL OCEAN 1\n`;
    ...
    message += `Mohon diproses request VPS DIGITAL OCEAN 1 saya. Terima kasih!\n\n`;
