function sendWhatsAppRequest() {
    ...
    let message = `*REQUEST VPS DIGITAL OCEAN - SC POTATO*\n\n`;
    message += `*Detail Request:*\n`;
    message += `• *Server:* DIGITAL OCEAN 2\n`;
    ...
    message += `Mohon diproses request VPS DIGITAL OCEAN 2 saya. Terima kasih!\n\n`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add special effects for premium server
